...
trait FileHandler
{
    ...
    public function uploadInvoiceImage(UploadedFile $uploadedFile = null, $folder = "invoices", $height = 1080): ?string
    {
        return $this->uploadImage($uploadedFile, $folder, $height);
    }
